defmodule LiveViewStudioWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      LiveViewStudioWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule LiveViewStudioWeb.PageLive do
        ...
        on_mount {LiveViewStudioWeb.UserAuth, :mount_current_user}
        ...
      end
