defmodule LiveViewStudioWeb.BookingsLive do
  ...
  def render(assigns) do
    ...
    <div id="bookings">
      <div id="wrapper" phx-update="ignore">
        ...
        <%!-- Outra forma de passar dados para o hook, dessa forma
          o hook faz o request dos dados e o live view reply os dados.
          Dessa forma eh melhor caso tenha um grande numero de dados para
          nao ficar esperando o loading demorado
  ...
  def handle_event("unavailable-dates-request", _, socket) do
